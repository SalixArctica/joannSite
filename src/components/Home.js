        ...
        <Row style={{marginTop: '50px'}}>
          <Col md={12} lg={6}>
            ...
            <div style={{overflow: 'auto'}}>
              <Image style={featuredImageStyle} src={process.env.PUBLIC_URL + '/assets/productsOil.png'}/>
              <h3>HempWorx Thing</h3>
              <p>Class aptent taciti sociosqu ad litora torquent per conubia nostra, per inceptos himenaeos. Maecenas finibus elit nec dignissim accumsan. Mauris faucibus metus at commodo facilisis. Suspendisse scelerisque malesuada interdum. Quisque lobortis sit amet lacus ut rutrum. Nulla vestibulum fermentum velit, vel convallis ipsum sodales et. Vivamus et turpis sed erat feugiat posuere. Pellentesque ut sem vel massa congue molestie.</p>
          ...
          <Col md={12} lg={6}>
            ...
            <Link to='#' style={featuredStyle}>
              ...
              <h3 style={{textAlign: 'center'}}>Tacos de Carne</h3>
            </Link>
          </Col>
        </Row>
      </Grid>
